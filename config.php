...
define('FS_DB_HOST', 'mysql.hostinger.es');
define('FS_DB_PORT', '3306'); /// MYSQL -> 3306, POSTGRESQL -> 5432
define('FS_DB_NAME', 'u575085774_fscv');
define('FS_DB_USER', 'u575085774_root'); /// MYSQL -> root, POSTGRESQL -> postgres
define('FS_DB_PASS', 'wilmercomasrosario30');

/*
 * Un directorio de nombre aleatorio para mejorar la seguridad del directorio temporal.
 */
define('FS_TMP_NAME', '8pIztcQsK1HM0eDCuhdU/');
...
define('FS_CACHE_HOST', 'fdb15.runhosting.com');
define('FS_CACHE_PORT', '11211');
define('FS_CACHE_PREFIX', 'cTCwhUkS_');
